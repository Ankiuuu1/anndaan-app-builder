    ...
    <MobileShell>
      <div className="flex flex-col min-h-screen p-6">
        <div className="flex items-center gap-2 mb-10 mt-4">
          ...
          <span className="font-bold text-lg">AnnDaan</span>
        </div>

        <h1 className="text-2xl font-bold tracking-tight">Welcome back</h1>
        <p className="text-sm text-muted-foreground mt-1">Sign in to continue saving and sharing food.</p>
        ...
        <Button variant="outline" className="w-full h-12 rounded-xl gap-2" onClick={google} disabled={loading}>
